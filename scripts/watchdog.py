...
def _send_alert(msg: str):
    # Lectura vía env_str (config/settings.py), no cruda: en GitHub Actions un
    # secret sin configurar se expande a "" y una lectura cruda del entorno
    # devuelve ese "" en lugar del default. env_str normaliza "" y whitespace
    # al default, así que el guard de abajo detecta credenciales ausentes de
    # forma confiable.
