...
# ── ENRICHMENT (markets specialty vía /events/{id}/odds) ────────────
# Ventana de días hacia adelante para enriquecer eventos con markets
# specialty. Más corta que FETCH_DAYS_AHEAD porque el enrichment cuesta
# ~7 créditos por evento y las odds specialty se mueven mucho.
ENRICH_DAYS_AHEAD = env_int("ENRICH_DAYS_AHEAD", 2)
# TTL del cache de enrichment. Igual al TTL general: 2 fetches/día.
