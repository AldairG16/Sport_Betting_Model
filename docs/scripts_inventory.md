...
|---|---|---|---|---|---|
| `audit_analyst_calibration.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
...
| `collect_match_events.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `enrich_matches.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `fetch_results.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `fetch_results_backup_fbdata.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `load_extra_leagues.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `load_historical_data.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `load_international_data.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `load_mlb_data.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `notify_telegram.py` | manual | unknown | no | manual | Sin notas operativas registradas. |
| `orchestrator.py` | weekly.yml | unknown | yes | daily-pipeline | Sin notas operativas registradas. |
| `pre_kickoff_analyst.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `resolve_pending_bets.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
| `update_closing_odds.py` | manual | unknown | yes | manual | Sin notas operativas registradas. |
